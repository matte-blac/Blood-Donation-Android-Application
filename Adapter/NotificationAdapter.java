...
public class NotificationAdapter extends  RecyclerView.Adapter<NotificationAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        getUserInfo(holder.notification_profile_picture, holder.notification_name, notification.getSenderID());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public CircleImageView notification_profile_picture;
        public TextView notification_name, notification_text, notification_date;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);

            notification_profile_picture = itemView.findViewById(R.id.notification_profile_picture);
